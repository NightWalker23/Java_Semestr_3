...
public class Crawler
{
    ...
    private List<ListenerIteracji> LisIteracji = new ArrayList<>();

    public void addLisIteracji( ListenerIteracji i )
    {
        LisIteracji.add( i );
    }

    private List<ListenerStudentow> LisAddStudent = new ArrayList<>();

    public void addLisAddStudent( ListenerStudentow st )
    {
        LisAddStudent.add( st );
    }

    private List<ListenerStudentow> LisDelStudent = new ArrayList<>();

    public void addLisDelStudent( ListenerStudentow st )
    {
        LisDelStudent.add( st );
    }
    ...
    private List<Student> extractStudents( OrderMode md )
    {
        List<Student> posortowani = new ArrayList<>( students );
        switch ( md )
        {
            case MARK:
    ...
    private double extractMarks( ExtremumMode md )
    {
        double extremum = 0;
        switch ( md )
        {
    ...
    private int extractAge( ExtremumMode md )
    {
        int extremum = 0;
        switch ( md )
        {
